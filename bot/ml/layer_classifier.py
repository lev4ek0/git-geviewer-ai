...
- Ошибки, связанные с бизнес-логикой (InvalidUserError).
2. adapters
**Ключевые признаки**:
...
- В случае работы с базами данных:
- Названия таблиц в snake_case, именуются в зависимости от их назначения (множественное число для сущностей, единственное для логов).
- Код запросов хранится в репозиториях.
**Основные роли**:
